 ...
 * File: _coder_matlab_linear_api.c
 *
...
void matlab_linear_atexit(void)
{
  ...
  matlab_linear_xil_terminate();
  matlab_linear_xil_shutdown();
...
/*
 * File trailer for _coder_matlab_linear_api.c
 *
 * [EOF]
 */
